...
//public class ImportResourceDatum extends BaseDatum {
//    public static final String URL_FIELD = fieldName(ImportResourceDatum.class, "url");
//    public static final String LAST_FETCHED_FIELD = fieldName(ImportResourceDatum.class, "lastFetched");
//    public static final String LAST_UPDATED_FIELD = fieldName(ImportResourceDatum.class, "lastUpdated");
//    public static final String LAST_STATUS_FIELD = fieldName(ImportResourceDatum.class, "lastStatus");
//    public static final String CRAWL_DEPTH = fieldName(ImportResourceDatum.class, "crawlDepth");
//    
...
//
//    public ImportResourceDatum () {
//        super(FIELDS);
//    }
//
//    public ImportResourceDatum(TupleEntry tupleEntry) {
//        super(tupleEntry);
//        validateFields(tupleEntry.getFields(), FIELDS);
//    }
//    
//    public ImportResourceDatum(String url, long lastFetched, long lastUpdated, UrlStatus lastStatus, int crawlDepth) {
//        super(FIELDS);
//        setUrl(url);
